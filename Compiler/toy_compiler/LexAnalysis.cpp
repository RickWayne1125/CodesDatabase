...
//            cout << index << ' ' << (int) temp << endl;
            ...
            if (temp == ' ') {
                ...
                while (index < len) {
                    ...
                    if ((temp >= 'a' && temp <= 'f' && flag == 1) || (temp >= '0' && temp <= '9')) {
                        ...
                        if (flag == 0) {
                            ...
                            str += temp;
                            flag = 3;
                        } else if (flag == 2 || flag == 3) {    // 两次出现浮点号说明浮点错误
                            flag = DOUBLE_ERROR;
                            break;
                        }
                ...
                int v = flag == 0 ? INTEGER : flag == 1 ? HEXINT : flag == 2 ? DOUBLE : flag == 3 ? HEXDOU : flag;
